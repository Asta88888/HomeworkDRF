...
class LessonTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.lesson = Lesson.objects.create(name='Урок', description='Описание урока', url="https://youtube.com/video", course=self.course, owner=self.user)
    ...
    def test_lesson_update(self):
        ...
        data = {
            "name": "Тест урока",
            "description": "Описание теста урока"
        }
