...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        course, created = Course.objects.get_or_create(
            ...
            defaults={
                "description":
                    "Python для начинающих — это простой и читаемый язык программирования, "
                    "который подходит для первых шагов в IT."
            },
        )
        if created:
        ...
        lesson, created = Lesson.objects.get_or_create(
            ...
            course=course,
            defaults={"description": "Первый урок по Python", "url": "https://example.com/python-intro"},
        )
        if created:
